...
@interface ViewController () <LTPhotoBrowserDatasource>
...
{
    LTPhotoBrowser *browser = [LTPhotoBrowser showPhotoBrowserWithCurrentImageIndex:tap.view.tag imageCount:self.images.count datasource:self];
    browser.browserStyle = LTPhotoBrowserStylePageControl; // 微博样式
    browser.pageControlStyle = LTPhotoBrowserPageControlStyleClassic;
...
- (UIImage *)photoBrowser:(LTPhotoBrowser *)browser placeholderImageForIndex:(NSInteger)index
{
