...
@interface LTZoomingScrollView () <UIScrollViewDelegate>
{
...
@implementation LTZoomingScrollView
...
- (LTProgressView *)progressView {
    if (!_progressView) {
        _progressView = [[LTProgressView alloc] init];
...
- (UILabel *)stateLabel {
    if (!_stateLabel) {
        ...
        [_stateLabel setText:LTPhotoBrowserLoadNetworkImageFail];
